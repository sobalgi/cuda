...
def experiment(args):
    ...
    log_num = 0
    log_file = logs_dir + '/' + hostname + '_' + machinename + '_' + args.exp + '_' + str(log_num) + '_' + args.epoch_size + '_ss_tu_su_ta_sa' + '.txt'

    # Setup logfile to store output logs
    if log_file is not None:
        while os.path.exists(log_file):
            log_num += 1
            log_file = '{0}/{3}_{1}_{2}_{4}_ss_tu_su_ta_sa.txt'.format(args.logs_dir, args.exp, log_num, hostname, args.epoch_size)
        # return
    ...
    ckpt_dir = os.path.join(absolute_base_path, args.ckpt_dir, hostname + '_' + machinename + '_' + args.exp) + '_' + str(log_num) + '_' + args.epoch_size + '_ss_tu_su_ta_sa'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--network_type', type=str, default='man', help='type of network [se|mcd|dade]')
