...
def experiment(args):
    ...
    try:
        ...
        for epoch in range(num_epochs):
            ...
            # if use_sampler:
            for i, ((X_src, y_src), (_, _)) in enumerate(zip(l_src_train, l_tgt_train)):
            ...
            #         X_tgt, _ = tgt_data_iter.next()  # Target Domain Labels should not be used
                ...
                total_classifier_loss = lambda_ssl * ramp_sup_weight_in_list[0] * src_sup_loss # + lambda_sul * ramp_unsup_weight_in_list[0] * src_unsup_loss + lambda_tul * ramp_unsup_weight_in_list[0] * tgt_unsup_loss  + lambda_sal * src_adv_loss + lambda_tal * tgt_adv_loss  # Total Encoder + Classifier loss for Enc + Class training
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epoch_size', default='source', choices=['large', 'small', 'source', 'target'], help='epoch size is either that of the smallest dataset, the largest, the source, or the target (default=source)')
