...
def experiment(args):
    ...
    try:
        ...
        log_str += log('Generator : {}'.format(net.GT))
        ...
        for epoch in range(num_epochs):
            ...
            #         X_tgt, _ = tgt_data_iter.next()  # Target Domain Labels should not be used
                ...
                total_classifier_loss = lambda_ssl * ramp_sup_weight_in_list[0] * src_sup_loss + lambda_tul * ramp_unsup_weight_in_list[0] * tgt_unsup_loss  + lambda_tal * tgt_adv_loss  # + lambda_tal * tgt_adv_loss  # Total Encoder + Classifier loss for Enc + Class training
                ...
                loss_gen = loss_tgt_gen  # + loss_tgt_gen
